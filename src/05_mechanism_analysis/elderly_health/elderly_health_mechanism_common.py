...
# -*- coding: utf-8 -*-
"""
Common helper functions for elderly-health mechanism-analysis scripts.
"""
...
def standardize_index_direction(s: pd.Series, positive_direction: bool = True) -> pd.Series:
    x = pd.to_numeric(s, errors="coerce")
    return x if positive_direction else -x
