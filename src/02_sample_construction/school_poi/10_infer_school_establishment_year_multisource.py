#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Archived notebook note for 10_infer_school_establishment_year_multisource.
...
SCHOOL_SHP = r"D:\GISdata\CHINA_SCHOOL\yunnan_小学_中学.shp"
EULUC_SHP  = r"D:\GISdata\EULUC\24yunnan.shp"

CLCD_ROOT     = r"D:\GISdata\landcover"
CLCD_PROVINCE = "yunnan"   # CLCD_v01_YYYY_albert_yunnan.tif

NTL_ROOT = r"D:\GISdata\Night_Light\yunnan"
...
L1L2_SHP  = os.path.join(L1L2_DIR, "yunnan_school.shp")
L1L2_XLSX = os.path.join(L1L2_DIR, "yunnan_school.xlsx")
L3_SHP    = os.path.join(L3_DIR, "yunnan_school.shp")
L3_XLSX   = os.path.join(L3_DIR, "yunnan_school.xlsx")
...
def index_clcd_files():
    ...
    if not year_files:
        raise RuntimeError("未找到 CLCD_v01_YYYY_albert_yunnan.tif")
